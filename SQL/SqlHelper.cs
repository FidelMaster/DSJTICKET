...
namespace HLP
{
    public class SqlHelper
    {
        ...
        //Comentariado por JMC
        //private string strNombreCadenaConexion = "CSUser";
        private string strNombreCadenaConexion = "DSJTicker";
        /// <summary>
        ...
        //Comentariado por JMC
        //public SqlConnection conexion = new SqlConnection(ConfigurationManager.ConnectionStrings["CSUser"].ConnectionString);
        public SqlConnection conexion = new SqlConnection(ConfigurationManager.ConnectionStrings["CDI_CONEX"].ConnectionString);
