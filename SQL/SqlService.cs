...
namespace HLP
{
    ...
    public class SqlService
    {
        ...
        public SqlService()
        {
            //_connectionString = ConfigurationManager.AppSettings["connectionStrings"];
            _connectionString = ConfigurationManager.ConnectionStrings["DSJTicket"].ConnectionString;
        }
        ...
        {
            string host = "LAPTOP-URF39FA9";
            string db = "DSJTicket";
            this.ConnectionString = "Server=" + host + ";Database=" + db + ";Integrated Security=true;";
        }
        ...
        {
            return ExecuteSqlDataSet(sql).Tables[0];
        }

        public DataTable ExecuteSP(string sql)
        {
            return ExecuteSPDataSet(sql).Tables[0];
        }

        public void ExecutedSql(string sql)
        {
        ...
        public DataTable ExecutarSP(string procedureName)
        {

            return ExecuteSPDataSet(procedureName).Tables[0];
        }
        ...
        public void ExecutedSP(string procedureName)
        {
            SqlCommand cmd = new SqlCommand();
            this.Connect();
